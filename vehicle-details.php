...
<head>
    ...
    <meta name="description" content="View vehicle details and taxi options offered by India Taj Holidays for comfortable tours and transfers.">
    <meta name="keywords" content="vehicle details, taxi options, India Taj Trip, sedan SUV tempo traveller, Agra taxi">
    ...
    <!-- Title -->
    <title>Vehicle Details | India Taj Trip</title>
                ...
                <div class="col-xl-7 col-lg-8">
                    <div class="package-details-warpper">
                        <div class="package-info-wrap mb-60">
                            <h4>Taj Holidays Tour Vehicle</h4>
                            <p>Taj Holidays Tour offers comfortable and reliable private taxi service for Taj Mahal tours, Delhi to Agra trips, Golden Triangle tours, and local sightseeing. Our fleet includes well-maintained AC sedans, SUVs, tempo travellers, and luxury cars with professional drivers to ensure a safe and smooth journey. Whether you need an airport transfer, same-day tour, outstation cab, or customized holiday package, we provide affordable pricing, transparent fares, and 24/7 booking assistance for a hassle-free travel experience across Agra, Delhi, Jaipur, Mathura, and Vrindavan.</p>
                        ...
                        <div class="additional-info mb-60">
                            ...
                            <ul class="items-list two">
                                <li>
                                    ...
                                    <div class="content">
                                        <span>Professional & Verified Drivers</span>Experienced, background-verified drivers with proper licenses ensuring safe, punctual, and comfortable travel for local sightseeing and outstation trips.
                                    </div>
                                </li>
                                <li>
                                    <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="content">
                                        <span>Well-Maintained & Sanitized Vehicles</span>Regularly serviced AC cars with clean interiors, comfortable seating, and GPS-enabled tracking for a smooth and secure journey.
                                    </div>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingOne">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                ...
                                                aria-controls="flush-collapseOne">What types of vehicles are available with Taj Holidays Tour?</button>
                                        </h5>
                                        <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                            aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                We offer a wide fleet including AC sedans, SUVs, tempo travellers, and luxury cars for Taj Mahal tours, Delhi to Agra taxi service, local sightseeing, and outstation travel. All vehicles are well-maintained and suitable for family trips, corporate travel, and group tours.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingTwo">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseTwo">Are your vehicles available for airport and railway station transfers?</button>
                                        </h5>
                                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Yes, we provide reliable airport transfer and railway station pickup & drop service in Agra, Delhi, Jaipur, Mathura, and Vrindavan with professional drivers and on-time arrival guarantee.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingThree">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseThree">Is the taxi service suitable for outstation and multi-day tours?</button>
                                        </h5>
                                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingThree"
                                            data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Absolutely. Our outstation cab service is ideal for Golden Triangle tours, Delhi–Agra–Jaipur trips, and customized holiday packages with flexible booking options and comfortable long-distance travel.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingFour">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseFour">Are your drivers experienced and verified?</button>
                                        </h5>
                                        <div id="flush-collapseFour" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Yes, all our drivers are licensed, background-verified, and experienced in tourist routes including Taj Mahal sightseeing and North India tour circuits, ensuring safe and smooth travel.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingFive">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseFive">How can I book a vehicle with Taj Holidays Tour?</button>
                                        </h5>
                                        <div id="flush-collapseFive" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                You can book our private taxi service online, via phone call, or WhatsApp for instant confirmation. We provide transparent pricing, no hidden charges, and 24/7 customer support for a hassle-free booking experience.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="package-details-sidebar">
                        ...
                        <div class="customize-package-banner-wrap">
                            ...
                            <div class="counter-area">
                                ...
                                <h6> <strong><span class="counter">60</span>+</strong> Guide Await to Help You</h6>
                            </div>
