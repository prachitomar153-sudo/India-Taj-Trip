...
<head>
    ...
    <meta name="description" content="Agra overnight tour packages from Delhi or Jaipur with private AC car, hotel stay, Taj Mahal sunrise visit & guided sightseeing. Best price guaranteed.">
    <meta name="keywords" content="Agra overnight tour from Delhi,Agra overnight tour from Jaipur,Taj Mahal overnight tour package,Delhi to Agra 2 days tour,Jaipur to Agra tour package,private car Agra tour,Taj Mahal sunrise tour package,Golden Triangle Agra overnight tour">
    ...
    <!-- Title -->
    <title>Agra Overnight Tour Packages From Delhi or Jaipur</title>
        ...
        <div class="swiper home2-banner-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="banner-bg"
                        style="background-image:linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(assets/img/innerpages/agra-overnight-tour-packages-from-delhi-or-jaipur.jpg);">
                    </div>
                </div>
        ...
        <div class="banner-content-wrap">
            <div class="container">
                <div class="banner-content">
                    <h1>Agra Overnight Tour Packages from Delhi or Jaipur</h1>
                    <div class="batch">
                        <span>Agra / Delhi / Jaipur</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-7 col-lg-8">
                    <div class="package-details-warpper">
                        <div class="package-info-wrap mb-60">
                            <h4>Agra Overnight Tour Packages From Delhi or Jaipur</h4>
                            <p>Discover the timeless beauty of the Taj Mahal with this comfortable Agra Overnight Tour from Delhi or Jaipur. This tour allows travelers to explore the historical city of Agra at a relaxed pace while experiencing the rich Mughal heritage, architecture, and culture. Travel conveniently by private car and enjoy a guided Agra sightseeing tour with an expert guide.

                            During this Taj Mahal overnight tour, visit the world-famous Taj Mahal, a UNESCO World Heritage Site and one of the Seven Wonders of the World, along with the majestic Agra Fort and the elegant Itmad-ud-Daulah (Baby Taj) known for its intricate marble inlay work. The overnight stay in Agra also gives you the opportunity to enjoy a magical Taj Mahal sunrise view, making this Agra tour package from Delhi or Jaipur</p>
...
<ul class="itinerary-list">
  ...
  <li class="single-itinerary">
    <div class="location-title">
      ...
      <h5>Day 1 <span>( Departure: <strong>7:00 am - 8:00 am</strong> )</span></h5>
    </div>
    <p>
      Pickup from <strong>Delhi or Jaipur Airport / Hotel / Railway Station</strong> and drive to 
      <strong>Agra</strong> in a comfortable private car. Upon arrival, meet your professional tour guide 
      and begin sightseeing with a visit to the magnificent <strong>Taj Mahal</strong>, one of the 
      Seven Wonders of the World built by Emperor Shah Jahan in memory of his beloved wife Mumtaz Mahal.
    </p>
    <p>
      After exploring the Taj Mahal, enjoy lunch at a recommended local restaurant (optional). 
      Later visit the historic <strong>Agra Fort</strong>, a UNESCO World Heritage Site and former 
      residence of the Mughal emperors. In the evening explore Agra’s famous markets known for 
      marble handicrafts and traditional souvenirs.
    </p>
    <p>
      Check in to the hotel and relax. Overnight stay in <strong>Agra</strong>.
    </p>
  </li>
  ...
  <li class="single-itinerary">
    <div class="location-title">
      ...
      <h5>Day 2 <span>( Departure: <strong>6:30 am - 7:00 am</strong> )</span></h5>
    </div>
    <p>
      Early morning you may enjoy another beautiful view of the <strong>Taj Mahal at sunrise</strong>. 
      Return to the hotel for breakfast and check out.
    </p>
    <p>
      Later visit the exquisite <strong>Itmad-ud-Daulah (Baby Taj)</strong>, famous for its delicate 
      marble inlay work and Mughal architecture. After completing the sightseeing, drive back to 
      <strong>Delhi or Jaipur</strong>.
    </p>
    <p>
      Upon arrival you will be dropped at your <strong>Hotel / Airport / Railway Station</strong>. 
      The tour ends with wonderful memories of the <strong>Agra Overnight Tour</strong>.
    </p>
  </li>
...
Comfortable overnight stay in <strong>3★ / 4★ / 5★ hotel in Agra</strong> (as per selected package)  </li>
...
Licensed <strong>English-speaking tour guide in Agra</strong> for Taj Mahal and Agra sightseeing   </li>

          <li> <?php include('icons/right-tick-green.php'); ?>  Private Transportation
Air-conditioned private car with professional driver for <strong>Delhi / Jaipur – Agra – Delhi / Jaipur</strong> transfers and sightseeing  </li>
...
All applicable toll tax, parking charges, fuel costs and driver allowance included  </li>
        ...
        <div class="col-lg-12 col-md-12">
             <div class="single-feature-list">
                <h5>Excludes</h5>
                   <ul class="items-list two">
                    <li> <?php include('icons/wrong-tick-red.php'); ?>  Monument Entrance Fees Entry tickets for Taj Mahal, Agra Fort, Itmad-ud-Daulah and other monuments  </li>
                    ...
                    <li> <?php include('icons/wrong-tick-red.php'); ?>  Optional Activities Rickshaw ride, photography services or cultural shows  </li>
                                    ...
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingOne">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                ...
                                                aria-controls="flush-collapseOne">What are the main attractions covered in the Agra Overnight Tour?</button>
                                        </h5>
                                        <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                            aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                The Agra Overnight Tour includes visits to the world-famous Taj Mahal, Agra Fort, and Itmad-ud-Daulah (Baby Taj). You will also have time to explore local markets in Agra known for marble handicrafts and Mughal art.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingTwo">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseTwo">Can this tour start from both Delhi and Jaipur?</button>
                                        </h5>
                                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Yes, the Agra Overnight Tour can start from either Delhi or Jaipur. Our driver will pick you up from your hotel, airport, or railway station and take you to Agra in a comfortable private car.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingThree">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseThree">Is accommodation included in the Agra Overnight Tour?</button>
                                        </h5>
                                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingThree"
                                            data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Yes, the package includes a comfortable overnight stay in Agra at a 3★, 4★, or 5★ hotel depending on the package you choose. Breakfast at the hotel is usually included in the tour package.
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingFour">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseFour">What is the best time to visit the Taj Mahal during this tour?</button>
                                        </h5>
                                        <div id="flush-collapseFour" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                The best time to visit the Taj Mahal is early morning during sunrise when the monument looks most beautiful and the crowds are smaller. Many travelers prefer this magical sunrise view during their overnight stay in Agra.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingFive">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseFive">How long does it take to travel from Delhi or Jaipur to Agra?</button>
                                        </h5>
                                        <div id="flush-collapseFive" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                The travel time from Delhi to Agra is approximately 3–4 hours via Yamuna Expressway, while the journey from Jaipur to Agra takes around 4–5 hours by road depending on traffic conditions.
                                            </div>
                                        </div>
                                    </div>
                                </div>
