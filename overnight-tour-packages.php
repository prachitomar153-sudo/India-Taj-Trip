...
<head>
    ...
    <meta name="description" content="Overnight Tour Packages including Taj Mahal, Agra, Jaipur & Golden Triangle tours with private taxi, hotel stay & guided sightseeing.">
    <meta name="keywords" content="overnight tour packages, Taj Mahal overnight tour, Agra overnight tour, Golden Triangle overnight tour, Delhi to Agra tour package, private taxi tour India, Jaipur overnight trip">
    ...
    <!-- Title -->
    <title>Overnight Tour Packages |India Taj Trip Tour Packages</title>
            ...
            <div class="row">
                    ...
                    <div class="package-card">
                        <div class="package-img-wrap">
                            <a href="overnight-agra-tour-by-car-from-delhi.php" class="package-img">
                                <img src="assets/img/home1/tour-package-img1.jpg" alt="Overnight Agra Tour by Car from Delhi">
                            </a>
                          </div>
                    ...
                    <div class="package-card">
                        <div class="package-img-wrap">
                            <a href="agra-overnight-tour-packages-form-delhi-or-jaipur.php" class="package-img">
                                <img src="assets/img/home1/tour-package-img3.jpg" alt="Agra Overnight Tour Package from Delhi or Jaipur">
                            </a>
                        </div>
                        <div class="package-content">
                            <h5><a href="agra-overnight-tour-packages-form-delhi-or-jaipur.php">Agra Overnight Tour Package from Delhi or Jaipur</a></h5>
                            <div class="location-and-time">
                                <div class="location">
                                    <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <a href="agra-overnight-tour-packages-form-delhi-or-jaipur.php">Delhi / Jaipur</a>
                                </div>
                                <svg class="arrow" width="25" height="6" viewBox="0 0 25 6" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0 3L5 5.88675V0.113249L0 3ZM25 3L20 0.113249V5.88675L25 3ZM4.5 3.5H20.5V2.5H4.5V3.5Z"/>
                                </svg>
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                    <div class="package-card">
                            ...
                            <div class="swiper package-card-img-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="overnight-tour-varanasi.php" class="package-img">
                                            <img src="assets/img/home1/tour-package-img4.jpg" alt="Over Night Tour Varanasi">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="package-content">
                            <h5><a href="overnight-tour-varanasi.php">Over Night Tour Varanasi</a></h5>
                            <div class="location-and-time">
                                <div class="location">
                                    <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <a href="overnight-tour-varanasi.php">Varanasi</a>
                            ...
                            <div class="btn-and-price-area">
                                <a href="overnight-tour-varanasi" class="primary-btn1">
                                    <span>
                                        Book Now
                                        <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                            <path
