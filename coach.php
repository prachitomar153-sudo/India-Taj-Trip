...
<head>
    ...
    <meta name="description" content="luxury AC Coach Bus rental in Agra with Taj Holidays Tour for group tours, corporate travel, school trips, and Golden Triangle tours. Professional drivers, comfortable seating, affordable bus hire with 24/7 booking support.">
    <meta name="keywords" content="Coach Bus Rental in Agra, Luxury Bus Hire, AC Coach Bus Booking, Group Tour Bus Service, Corporate Bus Rental, School Trip Bus Hire, Golden Triangle Bus Tour, Outstation Coach Rental, Agra Bus Service, Taj Holidays Tour">
    ...
    <!-- Title -->
    <title>Coach Bus Rental in Agra| India Taj Trip</title>
                ...
                <div class="col-xl-7 col-lg-8">
                    <div class="package-details-warpper">
                        <div class="package-info-wrap mb-60">
                            <h4>Taj Holidays Tour Vehicle Coach Bus</h4>
                            <p>Taj Holidays Tour provides comfortable and spacious coach bus rental service for group tours, corporate events, school trips, and religious yatras across Agra, Delhi, Jaipur, Mathura, and Vrindavan. Our AC luxury coach buses come with pushback seats, ample luggage space, and experienced drivers, making them ideal for Golden Triangle tours, Taj Mahal group visits, and outstation travel. Enjoy safe, affordable, and reliable group transportation service with transparent pricing and professional support.</p>
                        ...
                        <div class="additional-info mb-60">
                            ...
                            <ul class="items-list two">
                                <li>
                                    ...
                                    <div class="content">
                                        <span>Comfortable Group Travel Experience</span>Spacious seating, powerful air-conditioning, and smooth suspension ensure relaxed long-distance travel for family groups, corporate teams, and tour operators.
                                    </div>
                                </li>
                                <li>
                                    <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="content">
                                        <span>Ideal for Tours & Events</span>Perfect for Golden Triangle tour groups, destination weddings, conferences, school excursions, and pilgrimage tours with customized travel plans and flexible booking options.
                                    </div>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingOne">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                ...
                                                aria-controls="flush-collapseOne">What is the seating capacity of your coach buses?</button>
                                        </h5>
                                        <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                            aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Our luxury coach buses are available in multiple seating capacities, suitable for small and large groups, including corporate travel, school tours, and Taj Mahal group sightseeing.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingTwo">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseTwo">Is the coach bus available for outstation tours?</button>
                                        </h5>
                                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Yes, we provide outstation coach bus rental for Delhi–Agra–Jaipur Golden Triangle tours, religious trips to Mathura & Vrindavan, and long-distance group travel across North India.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingThree">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseThree">Are your coach buses air-conditioned and comfortable?</button>
                                        </h5>
                                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingThree"
                                            data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                All our AC coach buses are equipped with pushback seats, ample legroom, luggage storage space, and professional drivers to ensure a safe and comfortable group travel experience.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingFour">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseFour">Can we book a coach bus for corporate events or weddings?</button>
                                        </h5>
                                        <div id="flush-collapseFour" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Absolutely. Our group transportation service is ideal for corporate events, exhibitions, destination weddings, conferences, and family functions with customized pickup and drop services.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingFive">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseFive">How can I book a coach bus with Taj Holidays Tour?</button>
                                         </h5>
                                        <div id="flush-collapseFive" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                You can book our coach bus rental service online, by phone, or via WhatsApp for quick confirmation. We offer competitive pricing, transparent fare structure, and 24/7 customer assistance.
                                            </div>
                                        </div>
                                    </div>
                                </div>
