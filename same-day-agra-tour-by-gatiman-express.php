...
<head>
    ...
    <meta name="description" content="Same Day Agra Tour by Gatiman Express from Delhi. Visit Taj Mahal, Agra Fort & Mehtab Bagh with private AC car, guide & hassle-free return journey.">
    <meta name="keywords" content="Same Day Agra Tour by Gatiman Express, Taj Mahal tour by train, Delhi to Agra train tour, Gatiman Express Taj Mahal trip, one day Agra tour, Taj Mahal same day tour from Delhi, Agra tour package by train, Taj Mahal sightseeing tour">
    ...
    <!-- Title -->
    <title>Same Day Agra Tour by Gatiman Express | Taj Mahal Trip</title>
        ...
        <div class="swiper home2-banner-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="banner-bg"
                        style="background-image:linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(assets/img/innerpages/same-day-agra-tour-by-gatiman-express.jpg);">
                    </div>
                </div>
        ...
        <div class="banner-content-wrap">
            <div class="container">
                <div class="banner-content">
                    ...
                    <h1>Same Day Agra Tour by Gatiman Express</h1>
                    <div class="batch">
                        <span>Same Day</span>
                    </div>
                </div>
                  ...
                  <div class="col-xl-7 col-lg-8">
                    <div class="package-details-warpper">
                        <div class="package-info-wrap mb-60">
                            <h4>Same Day Agra Tour by Gatiman Express</h4>
                            <p>Experience a hassle-free Same Day Agra Tour by Gatiman Express, India’s fastest train connecting Delhi to Agra in just around 100 minutes. This well-planned Taj Mahal day tour includes round-trip train tickets, private AC car for Agra sightseeing, and visit to iconic monuments like Taj Mahal, Agra Fort, and Mehtab Bagh. Ideal for travelers seeking a quick, comfortable, and luxury day trip from Delhi with professional tour assistance.</p>
                            ...
                            <div class="highlights-wrap">
                                <ul class="items-list">
                                    <li>
                                        ...
                                        Round-trip journey by Gatiman Express train (Delhi–Agra–Delhi)
                                    </li>
                                    <li>
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        Guided visit to Taj Mahal & Agra Fort (UNESCO World Heritage Sites)
                                    </li>
                                    <li>
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        Private AC car with driver for Agra sightseeing
                                        </li>
                                        <li>
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        Buffet meals served onboard the train
                                    </li>
                                    <li>
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        Same-day return to Delhi – perfect for short trips
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<ul class="itinerary-list">
  ...
  <li class="single-itinerary">
    ...
    <p>
      Early morning pickup from your <strong>Delhi Hotel</strong> and transfer to 
      <strong>Hazrat Nizamuddin Railway Station</strong> to board the 
      <strong>Gatimaan Express Train</strong> to Agra. The train departs around 8:10 AM 
      and reaches <strong>Agra Cantt Railway Station</strong> in about 100 minutes.
    </p>
    <p>
      Upon arrival in Agra, meet your professional tour guide and begin sightseeing with 
      a visit to the magnificent <strong>Taj Mahal</strong>, one of the Seven Wonders of the World 
      and a symbol of eternal love built by Emperor Shah Jahan for Mumtaz Mahal.
    </p>
    <p>
      After visiting the Taj Mahal, enjoy lunch at a local restaurant (optional). 
      Later visit the historic <strong>Agra Fort</strong>, a UNESCO World Heritage Site 
      that served as the main residence of the Mughal emperors. You may also visit the 
      beautiful <strong>Itmad-ud-Daulah (Baby Taj)</strong>, known for its intricate marble work.
    </p>
    <p>
      In the evening transfer back to <strong>Agra Cantt Railway Station</strong> to board the 
      <strong>Gatimaan Express</strong> back to Delhi. Upon arrival at 
      <strong>Hazrat Nizamuddin Railway Station</strong>, our driver will transfer you to 
      your <strong>Hotel / Airport</strong>. The tour ends with wonderful memories of the Taj Mahal.
    </p>
  </li>
     ...
     <div class="col-lg-12 col-md-12">
      <div class="single-feature-list">
        <h5>Includes</h5>
         ...
         <li> <?php include('icons/right-tick-green.php'); ?> Train Tickets
Round-trip tickets on <strong>Gatimaan Express (Delhi – Agra – Delhi)</strong> in Executive / Chair Car class (as per selected package)  </li>

		 <li><?php include('icons/right-tick-green.php'); ?>  Private Transportation in Agra
Air-conditioned car with professional driver for Agra railway station transfers and local sightseeing  </li>
...
Licensed English-speaking tour guide in Agra for Taj Mahal and Agra sightseeing   </li>
          ...
          <li> <?php include('icons/right-tick-green.php'); ?>  Hotel / Station Pickup & Drop
Pickup and drop-off service in Delhi and Agra for smooth travel experience  </li>
             ...
             <div class="single-feature-list">
                <h5>Excludes</h5>
                   <ul class="items-list two">
                    ...
                    <li> <?php include('icons/wrong-tick-red.php'); ?>  Meals Not Mentioned Lunch or refreshments not specified in the itinerary  </li>
                  </ul>
             </div>
          </div>
        </div>
                                    ...
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingOne">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                ...
                                                aria-controls="flush-collapseOne">How long does the Gatiman Express take from Delhi to Agra?</button>
                                        </h5>
                                        <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                            aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                The Gatiman Express train takes approximately 100 minutes to reach Agra from Delhi, making it the fastest and most convenient option for a same-day Taj Mahal tour.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingTwo">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseTwo">Is the Taj Mahal entry ticket included in the tour package?</button>
                                        </h5>
                                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Entry tickets to Taj Mahal and Agra Fort can be included depending on the selected package. Some options offer all-inclusive pricing with monument tickets and tour guide service.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingThree">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseThree">Do we get a private car in Agra for sightseeing?</button>
                                        </h5>
                                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingThree"
                                            data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Yes, the tour includes a private AC car with professional driver for comfortable Agra sightseeing after arriving at Agra Cantt Railway Station.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <h5 class="accordion-header" id="flush-headingFour">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseFour">Is food included in the Gatiman Express tour?</button>
                                        </h5>
                                        <div id="flush-collapseFour" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Yes, meals are served onboard Gatiman Express, including breakfast and dinner depending on travel schedule.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseFive" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                Absolutely. This Delhi to Agra same-day tour by train is ideal for international tourists, families, and business travelers looking for a quick and organized Taj Mahal visit.
                                            </div>
                                        </div>
                                    </div>
                                </div>
