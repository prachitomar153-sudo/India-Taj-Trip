...
<head>
    ...
    <meta name="description" content="Contact India Taj Trip for Golden Triangle tours, Same Day Taj Mahal tours, and comfortable taxi services across North India.">
    <meta name="keywords" content="Contact India Taj Trip, Agra tour operator, taxi services, Golden Triangle tour booking, Taj Mahal tour contact">
    ...
    <!-- Title -->
    <title>Contact India Taj Trip | Tours & Taxi</title>
            ...
            <div class="row g-xl-4 g-lg-3 g-4 mb-100">
                <div class="col-lg-4 col-md-6">
                    <div class="single-contact">
                        ...
                        <h4>Agra</h4>
                        <h6><a href="#">Vinayak Kunj Colony,Agra</a></h6>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-contact three">
                        ...
                        <h4>Email</h4>
                        <h6><a href="#">info@indiatajtrip@gmail.com</a></h6>
                                ...
                                <div class="row g-4 mb-60">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-inner">
                                            ...
                                            <input type="text" placeholder="+91 7500 *** ***">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-inner">
