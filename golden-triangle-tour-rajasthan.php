...
<head>
    ...
    <meta name="description" content="India’s most famous travel route with the Golden Triangle Tour Rajasthan covering Delhi, Agra, and Jaipur. Discover the Taj Mahal, Amber Fort, historic Mughal monuments, vibrant markets, and royal palaces on this unforgettable cultural journey.">
    <meta name="keywords" content="golden triangle tour rajasthan, golden triangle tour india, delhi agra jaipur tour, golden triangle tour package, rajasthan golden triangle tour, taj mahal jaipur delhi tour, india golden triangle itinerary, golden triangle travel india, delhi agra jaipur sightseeing tour, rajasthan heritage tour">
    ...
    <!-- Title -->
    <title>Golden Triangle Tour Rajasthan | Delhi Agra Jaipur Tour Package</title>
    ...
    <div class="breadcrumb-section two">
        <div class="swiper home2-banner-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="banner-bg"
                        style="background-image:linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(assets/img/innerpages/golden-triangle-tour-rajasthan.jpg);">
                    </div>
                </div>
        ...
        <div class="banner-content-wrap">
            <div class="container">
                ...
                <h1>Golden Triangle Tour Rajasthan</h1>
                    <div class="batch">
                        <span>3 Days</span>
                    </div>
                </div>
                ...
                <div class="col-xl-7 col-lg-8">
                    <div class="package-details-warpper">
                        <div class="package-info-wrap mb-60">
                            <h4>Golden Triangle Tour Rajasthan</h4>
                            <p>The Golden Triangle Tour Rajasthan is one of the most popular travel circuits in India, connecting the historic cities of Delhi, Agra, and Jaipur. This classic journey offers travelers a perfect introduction to India’s rich culture, royal heritage, and magnificent architecture. The route forms a triangle on the map and showcases some of the country’s most iconic landmarks.

                            The tour begins in Delhi, the vibrant capital of India, where travelers explore historical monuments such as India Gate, Qutub Minar, Humayun’s Tomb, and Jama Masjid. The journey then continues to Agra, home to the world-famous Taj Mahal, a UNESCO World Heritage Site and one of the Seven Wonders of the World, along with the majestic Agra Fort.</p>
							...
							<p> 
								...
								<span class="location_box_design"> <?php include('icons/location.php'); ?> <strong>Udaipur</strong> </span>
							  </p> 
                           </div>
                            </div>
                            ...
                            <div class="highlights-wrap">
                                <ul class="items-list">
                                    ...
                                    <li>
                                        ...
                                        Explore historic monuments of Old and New Delhi
                                    </li>
                                    <li>
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        Discover the royal heritage of Jaipur – The Pink City
                                    </li>
                                    <li>
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                       ...
                                       Experience vibrant local markets, culture, and traditional crafts
                                    </li>
                                    <li>
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
...
<ul class="itinerary-list">
  ...
  <li class="single-itinerary">
    <div class="location-title">
      ...
      <h5>Day Tour <span>( Departure: <strong>8:00 am - 8:30 am</strong> )</span></h5>
    </div>
    <p>
      Pickup from your <strong>Delhi Hotel / Airport / Railway Station</strong> and begin your 
      exciting <strong>Same Day Delhi City Tour</strong>. Start your sightseeing with a visit to 
      <strong>Old Delhi</strong>, where you will explore the historic <strong>Jama Masjid</strong>, 
      one of the largest mosques in India. Experience the lively atmosphere of 
      <strong>Chandni Chowk</strong> and enjoy a photo stop at the iconic 
      <strong>Red Fort</strong>.
    </p>

    <p>
      Continue your tour with a visit to <strong>Raj Ghat</strong>, the memorial of 
      <strong>Mahatma Gandhi</strong>. After exploring Old Delhi, proceed to 
      <strong>New Delhi</strong> and drive past the grand <strong>President House</strong> and 
      <strong>Parliament House</strong>. Stop at the famous war memorial 
      <strong>India Gate</strong> for photographs.
    </p>

    <p>
      Later visit the UNESCO World Heritage Site <strong>Humayun’s Tomb</strong>, an impressive 
      example of Mughal architecture. Continue your sightseeing at the magnificent 
      <strong>Qutub Minar</strong>, the tallest brick minaret in the world and another 
      UNESCO World Heritage Site in Delhi.
    </p>

    <p>
      End your sightseeing with a visit to the peaceful <strong>Lotus Temple</strong>, 
      famous for its unique flower-shaped architecture and serene environment. 
      After completing the tour, you will be dropped back at your 
      <strong>Hotel / Airport / Railway Station in Delhi</strong> with unforgettable memories 
      of your <strong>Delhi sightseeing tour</strong>.
    </p>
  </li>
...
Air-conditioned private car with professional driver for the complete <strong>Delhi city sightseeing tour</strong>  </li>

		 <li><?php include('icons/right-tick-green.php'); ?>  Guided Tours & Excursions
Licensed <strong>English-speaking tour guide</strong> for exploring Old Delhi and New Delhi attractions  </li>

          <li> <?php include('icons/right-tick-green.php'); ?>  Hotel / Airport Pickup & Drop
Convenient pickup and drop-off from <strong>Delhi Hotel / Airport / Railway Station</strong>  </li>

          <li> <?php include('icons/right-tick-green.php'); ?>  Sightseeing of Major Attractions
Visit famous landmarks including <strong>Jama Masjid, Chandni Chowk, India Gate, Qutub Minar, Humayun’s Tomb, and Lotus Temple</strong>  </li>
...
All applicable toll tax, parking charges, fuel costs and driver allowance included  </li>
        ...
        <div class="col-lg-12 col-md-12">
             <div class="single-feature-list">
                <h5>Excludes</h5>
                   <ul class="items-list two">
                    <li> <?php include('icons/wrong-tick-red.php'); ?>  Monument Entrance Fees Entry tickets for monuments and attractions visited during the tour  </li>
                    ...
                    <li> <?php include('icons/wrong-tick-red.php'); ?>  Optional Activities Rickshaw ride in <strong>Old Delhi / Chandni Chowk</strong> or other optional experiences  </li>
        ...
        <h4>Additional Info</h4>
         <ul class="items-list two">
          ...
          <div class="content">  <span>Free Cancellation</span> – Enjoy flexible booking with free cancellation available up to a certain period (usually 24 hours before the tour departure).
         </div>
        </li>
			 
         <li> <?php include('icons/right-tick-blue.php');?>
             <div class="content"> <span>Comfortable Travel</span>  The tour is conducted in a private air-conditioned vehicle with a professional driver to ensure a smooth and comfortable Delhi sightseeing experience.  </div>
         </li>

         <li> <?php include('icons/right-tick-blue.php');?>
             <div class="content"> <span>Professional Tour Guide</span>  A licensed English-speaking guide will accompany you at major monuments to provide historical insights and local knowledge.  </div>
         </li>

         <li> <?php include('icons/right-tick-blue.php');?>
             <div class="content"> <span>Health & Safety</span>  Hospitals, clinics, and pharmacies are easily accessible in Delhi in case of any medical needs during the tour.  </div>
         </li>
                                    ...
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingOne">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                ...
                                                aria-controls="flush-collapseOne">What places are covered in the Same Day Delhi Tour?</button>
                                        </h5>
                                        <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                            aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                The Same Day Delhi Tour covers the major attractions of both Old Delhi and New Delhi including <strong>Jama Masjid, Chandni Chowk, Red Fort (photo stop), Raj Ghat, India Gate, Humayun’s Tomb, Qutub Minar, Lotus Temple, and the President House area</strong>.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingTwo">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseTwo">How long does the Same Day Delhi Tour take?</button>
                                        </h5>
                                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                The Delhi sightseeing tour usually takes around <strong>8 to 10 hours</strong>, depending on traffic conditions and the time spent at each monument or attraction.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingThree">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseThree">Is a tour guide included in the Delhi city tour?</button>
                                        </h5>
                                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingThree"
                                            data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Yes, a professional <strong>English-speaking tour guide</strong> is available to explain the history, culture, and architecture of Delhi’s famous monuments and attractions.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingFour">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseFour">Can the Same Day Delhi Tour be customized?</button>
                                        </h5>
                                        <div id="flush-collapseFour" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Yes, the tour can be customized according to your preferences. You can add or skip certain attractions, include shopping in local markets such as <strong>Chandni Chowk or Connaught Place</strong>, or extend the tour duration if needed.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingFive">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseFive">What is the best time to take a Delhi sightseeing tour?</button>
                                        </h5>
                                        <div id="flush-collapseFive" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                The best time to explore Delhi is from <strong>October to March</strong> when the weather is pleasant for sightseeing. However, the Same Day Delhi Tour is available throughout the year.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="swiper home1-trip-slider">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="golden-triangle-tour-5-days.php" class="package-img">
                                            <img src="assets/img/home1/golden-triangle-tour-5-days.jpg" alt="Golden Triangle Tour 5 Days">
                                        </a>
                                    </div>
                                  </div>
                              </div>
                        ...
                        <div class="package-content">
                            ...
                            <div class="location-and-time">
                                <div class="location">
                                    ...
                                    <a href="golden-triangle-tour-5-days.php">Rajasthan</a>
                                </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="golden-triangle-tour-3-days.php" class="package-img">
                                            <img src="assets/img/home1/golden-triangle-tour-3-days.jpg" alt="Golden Triangle Tour 3 Days">
                                        </a>
                                    </div>
                                  </div>
                              </div>
                        ...
                        <div class="package-content">
                            ...
                            <div class="location-and-time">
                                <div class="location">
                                    ...
                                    <a href="golden-triangle-tour-3-days.php">Rajasthan</a>
                                </div>
                                <svg class="arrow" width="25" height="6" viewBox="0 0 25 6" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0 3L5 5.88675V0.113249L0 3ZM25 3L20 0.113249V5.88675L25 3ZM4.5 3.5H20.5V2.5H4.5V3.5Z"/>
                                </svg>
                        ...
                        <div class="package-img-wrap">
                            <div class="swiper package-card-img-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="golden-triangle-tour-varanasi.php" class="package-img">
                                            <img src="assets/img/home1/golden-triangle-tour-varanasi.jpg" alt="Golden Triangle Tour Varanasi">
                                        </a>
                                    </div>
                                  </div>
                              </div>
                        ...
                        <div class="package-content">
                            <h5><a href="golden-triangle-tour-varanasi.php">Golden Triangle Tour Varanasi</a></h5>
                            <div class="location-and-time">
                                <div class="location">
                                    <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <a href="golden-triangle-tour-varanasi.php">Varanasi</a>
                                </div>
                                <svg class="arrow" width="25" height="6" viewBox="0 0 25 6" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0 3L5 5.88675V0.113249L0 3ZM25 3L20 0.113249V5.88675L25 3ZM4.5 3.5H20.5V2.5H4.5V3.5Z"/>
                                </svg>
                            ...
                            <div class="btn-and-price-area">
                                <a href="golden-triangle-tour-varanasi.php" class="primary-btn1">
                                    <span>
                                        Book Now
                                        <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                            <path
