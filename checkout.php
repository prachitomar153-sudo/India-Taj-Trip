...
<head>
    ...
    <meta name="description" content="Complete your booking securely with India Taj Trip for tours and taxi services.">
    <meta name="keywords" content="India Taj Trip checkout, tour booking payment, taxi booking checkout">
    ...
    <!-- Title -->
    <title>Checkout | India Taj Trip</title>
                                        ...
                                        <ul>
                                            <li class="single-item">
                                                <div class="item-area">
                                                    <div class="main-item">
                                                        <div class="item-img">
                                                            <img src="assets/img/innerpages/cart-img1.png"
                                                                alt="">
                                                        </div>
