...
<head>
    ...
    <meta name="description" content="Urbaina taxi service with Taj Holidays Tour for Taj Mahal tours, Delhi to Agra cab, airport transfer, and outstation travel. Comfortable AC vehicle with professional driver, affordable fare, and instant booking support.">
    <meta name="keywords" content="Urbaina taxi service, Urbaina cab booking, Taj Mahal tour taxi, Delhi to Agra cab, Agra sightseeing taxi, private car rental Agra, outstation cab service, airport transfer taxi, Golden Triangle tour cab, AC taxi service India">
    ...
    <!-- Title -->
    <title>Urbaina Taxi Service for Taj Mahal Tour | India Taj Trip</title>
                ...
                <div class="col-xl-7 col-lg-8">
                    <div class="package-details-warpper">
                        <div class="package-info-wrap mb-60">
                            <h4>Urbaina Luxury Van</h4>
                            <p>Taj Holidays Tour presents the Urbaina Luxury Van, a premium choice for comfortable and stylish group travel, corporate trips, family tours, and VIP transfers. Designed with spacious interiors, reclining seats, powerful air conditioning, and ample luggage space, this luxury van is ideal for Taj Mahal tours, Golden Triangle tours, Delhi to Agra transfers, airport pickup, and outstation travel. Enjoy a smooth ride with professional chauffeurs, well-maintained vehicles, and transparent pricing for a first-class travel experience across Agra, Delhi, Jaipur, Mathura, and Vrindavan.</p>
                           </div>
                        ...
                        <div class="additional-info mb-60">
                            ...
                            <ul class="items-list two">
                                <li>
                                    ...
                                    <div class="content">
                                        <span>Spacious & Premium Interiors</span>Reclining pushback seats, wide windows, ambient lighting, and extra luggage space for comfortable long-distance group travel.
                                    </div>
                                </li>
                                <li>
                                    <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="content">
                                        <span>Ideal for Group Tours & Corporate Travel</span>Best suited for Taj Mahal sightseeing, Delhi–Agra–Jaipur tours, destination weddings, and business travel with professional chauffeur service.
                                    </div>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingOne">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                ...
                                                aria-controls="flush-collapseOne">How many passengers can the Urbaina Luxury Van accommodate?</button>
                                        </h5>
                                        <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                            aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                The Urbaina Luxury Van comfortably accommodates medium to large groups, making it ideal for group tours, corporate travel, family vacations, and Golden Triangle tour packages with ample seating and luggage space.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingTwo">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseTwo">Is the Urbaina Luxury Van suitable for long-distance outstation travel?</button>
                                        </h5>
                                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Yes, this luxury van rental service is perfect for long-distance travel such as Delhi–Agra–Jaipur tours, outstation cab service, and multi-day holiday packages, ensuring smooth and comfortable journeys.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingThree">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseThree">Does the Urbaina van include airport transfer services?</button>
                                        </h5>
                                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingThree"
                                            data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Absolutely. We provide luxury airport transfer and railway station pickup & drop service with professional chauffeurs for hassle-free arrivals and departures in Delhi, Agra, and Jaipur.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingFour">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseFour">Are the drivers experienced and verified?</button>
                                        </h5>
                                        <div id="flush-collapseFour" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Yes, all our chauffeurs are licensed, background-verified, and experienced in tourist routes, including Taj Mahal sightseeing tours and North India travel circuits.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingFive">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseFive">How can I book the Urbaina Luxury Van with Taj Holidays Tour?</button>
                                        </h5>
                                        <div id="flush-collapseFive" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                You can book the Urbaina luxury van rental online, via phone call, or WhatsApp for instant confirmation. We offer transparent pricing, flexible booking options, and 24/7 customer support.
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row justify-content-center mb-50">
                <div class="col-xl-6 col-lg-8">
                    <div class="section-title text-center">
                        <h2>Relevant Vehicle and Tour Packages</h2>
                        <p>A curated list of the most popular Vehicle and Tour Packages based on different destinations.</p>
                    </div>
                </div>
            </div>
            <div class="row mb-40">
