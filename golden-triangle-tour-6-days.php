...
<head>
    ...
    <meta name="description" content="Delhi, Agra & Jaipur with our 6 Days Golden Triangle Tour. Private AC car, hotel stay, Taj Mahal visit & customizable itinerary. Book now!.">
    <meta name="keywords" content="Golden Triangle Tour 6 Days, 6 Days Delhi Agra Jaipur Tour, Golden Triangle Tour Package India, Delhi Agra Jaipur Itinerary 6 Days, Taj Mahal Tour Package, Private Golden Triangle Tour, Golden Triangle Tour by Car, North India Tour Package">
    ...
    <!-- Title -->
    <title>Golden Triangle Tour 6 Days | Delhi Agra Jaipur Tour Package</title>
        ...
        <div class="swiper home2-banner-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="banner-bg"
                        style="background-image:linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(assets/img/innerpages/golden-triangle-tour-6-days.jpg);">
                    </div>
                </div>
            ...
            <div class="container">
                <div class="banner-content">
                  <h1>Golden Triangle Tour 6 Days</h1>
                    <div class="batch">
                        <span>6 Days | 5 Nights | 4 Destinations</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-7 col-lg-8">
                    <div class="package-details-warpper">
                        <div class="package-info-wrap mb-60">
                            ...
                            <p>Experience the best of North India with our Golden Triangle Tour 6 Days covering Delhi, Agra, and Jaipur. Explore iconic landmarks like the Taj Mahal, Agra Fort, Amber Fort, India Gate, Qutub Minar, Hawa Mahal, and City Palace with a private AC car and professional driver. This well-planned Delhi Agra Jaipur tour package offers comfortable accommodation, guided sightseeing, and seamless transfers, making it ideal for families, couples, and international travelers seeking a complete heritage and cultural experience in India.</p>
                            ...
                            <div class="highlights-wrap">
                                <ul class="items-list">
                                    <li>
                                        ...
                                        Visit the magnificent Taj Mahal at sunrise in Agra
                                    </li>
                                    <li>
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        Explore historic monuments in Old & New Delhi sightseeing tour
                                    </li>
                                    <li>
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        Discover royal heritage at Amber Fort & City Palace Jaipur
                                    </li>
                                    <li>
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        Enjoy comfortable travel with private AC car & driver
                                    </li>
                                    <li>
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        Ideal for Golden Triangle holiday package & cultural tour in India
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<ul class="itinerary-list">
  ...
  <li class="single-itinerary">
    ...
    <p>
      ...
      Drive past President House and Parliament House and explore the vibrant local markets.
  ...
  <li class="single-itinerary">
    ...
    <p>
      After breakfast, drive to <strong>Agra via Yamuna Expressway</strong>. Upon arrival, check in at the hotel.
      Visit the magnificent <strong>Taj Mahal</strong>, one of the Seven Wonders of the World and a symbol of eternal love.
      Later explore the historic <strong>Agra Fort</strong>, a UNESCO World Heritage Site.
      Evening free to explore local markets famous for marble handicrafts.
  ...
  <li class="single-itinerary">
    ...
    <p>
      After breakfast, drive towards <strong>Jaipur</strong>.
      En route visit the UNESCO World Heritage Site <strong>Fatehpur Sikri</strong>,
      the former capital of the Mughal Empire known for Buland Darwaza and Jama Masjid.
      Continue the journey to <strong>Jaipur – The Pink City</strong>. Upon arrival check in to the hotel and relax.
      Evening free for leisure or explore Jaipur’s colorful markets.
  ...
  <li class="single-itinerary">
    ...
    <p>
      After breakfast, enjoy a guided sightseeing tour of <strong>Jaipur</strong>.
      Visit the magnificent <strong>Amber Fort</strong>, followed by a photo stop at
      <strong>Hawa Mahal (Palace of Winds)</strong>. Continue to explore the royal
      <strong>City Palace</strong> and the astronomical observatory <strong>Jantar Mantar</strong>.
      Later visit local markets known for handicrafts, jewelry and textiles.
      Overnight stay in Jaipur.
    </p>
  </li>
  ...
  <li class="single-itinerary">
    <div class="location-title">
      ...
      <h5>Day 5 <span>( Departure: <strong>9:00 am - 9:30 am</strong> )</span></h5>
    </div>
    <p>
      After breakfast, enjoy a relaxed morning in Jaipur or explore nearby attractions.
      Optional visits include <strong>Nahargarh Fort</strong>, <strong>Jaigarh Fort</strong> or local markets.
      Later in the afternoon begin the drive back to <strong>Delhi</strong>.
  ...
  <li class="single-itinerary">
    <div class="location-title">
      ...
      <h5>Day 6 <span>( Departure: <strong>9:30 am - 10:00 am</strong> )</span></h5>
    </div>
    <p>
      After breakfast, enjoy some free time for last-minute shopping or relaxation.
      Later you will be transferred to <strong>Delhi Airport / Hotel / Railway Station</strong>
      for your onward journey. Your <strong>Golden Triangle Tour 6 Days</strong> ends with
      wonderful memories of Delhi, Agra and Jaipur.
    </p>
  </li>
...
Comfortable stay in 3★ / 4★ / 5★ hotels (as per selected package) in Delhi, Agra & Jaipur (Hotel, resort or heritage property options available)  </li>
...
Air-conditioned private vehicle with professional driver for the entire Golden Triangle journey including all transfers and sightseeing   </li>

          <li> <?php include('icons/right-tick-green.php'); ?>  All Toll Taxes & Parking
All applicable toll tax, parking charges, fuel costs, driver allowance and state taxes included   </li>
             ...
             <div class="single-feature-list">
                <h5>Excludes</h5>
                   <ul class="items-list two">
                    ...
                    <li> <?php include('icons/wrong-tick-red.php'); ?>  Monument Entrance Fees Entry tickets for Taj Mahal, Agra Fort, Amber Fort and other monuments  </li>
                                    ...
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingOne">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                ...
                                                aria-controls="flush-collapseOne">What cities are included in the Golden Triangle Tour 6 Days?</button>
                                        </h5>
                                        <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                            aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                The tour covers Delhi, Agra, and Jaipur, forming India’s famous Golden Triangle tourist circuit known for Mughal architecture, royal palaces, and UNESCO World Heritage Sites.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingTwo">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseTwo">Is the Taj Mahal included in this tour package?</button>
                                        </h5>
                                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Yes, the itinerary includes a dedicated Taj Mahal sightseeing tour in Agra, along with Agra Fort and optional visit to Fatehpur Sikri.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingThree">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseThree">What type of vehicle is provided during the tour?</button>
                                        </h5>
                                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingThree"
                                            data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                We provide a private AC car (Sedan/SUV/Tempo Traveller) depending on group size, ensuring comfortable long-distance travel between Delhi, Agra, and Jaipur.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingFour">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseFour">Can the Golden Triangle Tour be customized?</button>
                                        </h5>
                                        <div id="flush-collapseFour" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Yes, this Delhi Agra Jaipur tour package can be customized with hotel upgrades, professional tour guide services, and additional sightseeing options.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingFive">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseFive">Is this tour suitable for international travelers?</button>
                                        </h5>
                                        <div id="flush-collapseFive" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Absolutely. The Golden Triangle 6 Days tour is one of the most popular India tour packages for foreign tourists seeking history, culture, architecture, and heritage experiences.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-12">
                    <div class="swiper home1-trip-slider">
                        ...
                        <div class="package-img-wrap">
                            <a href="golden-triangle-tour-rajasthan.php" class="package-img">
                                <img src="assets/img/home1/tour-package-img1.jpg" alt="Golden Triangle Tour Rajasthan">
                            </a>
                          </div>
                        <div class="package-content">
                          <h5><a href="golden-triangle-tour-rajasthan.php">Golden Triangle Tour Rajasthan</a></h5>
                            <div class="location-and-time">
                                <div class="location">
                                    ...
                                    <a href="golden-triangle-tour-rajasthan.php">Same Day Agra Tour By Train</a>
                                </div>
                            ...
                            <div class="btn-and-price-area">
                                <a href="golden-triangle-tour-rajasthan.php" class="primary-btn1">
                                    <span>
                                        Book Now
                                        <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                            <path
