...
<head>
    ...
    <meta name="description" content="Experience the breathtaking Taj Mahal Sunrise Tour with private car, expert guide, and hotel pickup. Book same-day Agra tour at best price.">
    <meta name="keywords" content="Taj Mahal Sunrise Tour, Sunrise Taj Mahal Tour from Delhi, Taj Mahal morning tour, early morning Taj Mahal visit, private Taj Mahal tour, Taj Mahal tour by car, same day Agra tour, Delhi to Agra sunrise tour, Taj Mahal guided tour, Agra sunrise sightseeing">
    ...
    <!-- Title -->
    <title>Taj Mahal Sunrise Tour | Private Car & Guide Service</title>
        ...
        <div class="swiper home2-banner-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="banner-bg"
                        style="background-image:linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(assets/img/innerpages/taj-mahal-sunrise.jpg);">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-7 col-lg-8">
                    <div class="package-details-warpper">
                        <div class="package-info-wrap mb-60">
                            ...
                            <p>perience the breathtaking beauty of the Taj Mahal at sunrise on this unforgettable Taj Mahal Sunrise Tour from Delhi. Travel comfortably by car via the Yamuna Expressway and arrive in Agra early in the morning to witness the magical sunrise over the iconic white marble monument. As the first rays of sunlight illuminate the Taj Mahal, you will enjoy a peaceful and less crowded visit to one of the Seven Wonders of the World.

                           During this guided Agra sightseeing tour, explore the magnificent Agra Fort, a UNESCO World Heritage Site known for its impressive Mughal architecture. You may also visit Itmad-ud-Daulah (Baby Taj), famous for its intricate marble inlay work.</p>
...
<ul class="itinerary-list">
  ...
  <li class="single-itinerary">
    <div class="location-title">
      ...
      <h5>Day Tour <span>( Departure: <strong>2:30 am - 3:00 am</strong> )</span></h5>
    </div>
    <p>
      Early morning pickup from your <strong>Delhi Hotel / Airport</strong> and drive to 
      <strong>Agra via Yamuna Expressway</strong> (approx. 3–4 hours). Enjoy a comfortable 
      journey in a private air-conditioned car.
    </p>

    <p>
      Upon arrival in Agra, meet your professional tour guide and proceed to visit the 
      magnificent <strong>Taj Mahal at sunrise</strong>. Witness the breathtaking beauty 
      of the white marble monument as the first rays of the sun illuminate the Taj Mahal, 
      creating a magical and unforgettable experience.
    </p>

    <p>
      After visiting the Taj Mahal, enjoy breakfast at a recommended restaurant or hotel.
    ...
    <p>
      You may also visit the beautiful <strong>Itmad-ud-Daulah (Baby Taj)</strong>, famous 
      for its intricate marble inlay work. After completing the sightseeing, drive back 
      to <strong>Delhi</strong>. Upon arrival you will be dropped at your 
      <strong>Hotel / Airport / Railway Station</strong>. The tour ends with wonderful 
      memories of the Taj Mahal Sunrise Tour.
    </p>
  </li>
...
Comfortable travel in an <strong>air-conditioned private car</strong> with professional driver for Delhi – Agra – Delhi journey via Yamuna Expressway  </li>
...
Complimentary mineral water provided during the journey for your comfort   </li>
             ...
             <div class="single-feature-list">
                <h5>Excludes</h5>
                   <ul class="items-list two">
                    ...
                    <li> <?php include('icons/wrong-tick-red.php'); ?>  Meals Not Mentioned Breakfast, lunch or refreshments not specified in the itinerary  </li>
                  </ul>
             </div>
          </div>
        </div>
                                    ...
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingFour">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseFour">Will I get a
