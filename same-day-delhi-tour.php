...
<head>
    ...
    <meta name="description" content="Explore the best of India’s capital with a Same Day Delhi Tour. Visit famous attractions like India Gate, Qutub Minar, Jama Masjid, Red Fort, Humayun’s Tomb and Lotus Temple with a professional guide and comfortable private car.">
    <meta name="keywords" content="same day delhi tour, delhi city tour, delhi sightseeing tour, same day delhi sightseeing, old and new delhi tour, delhi private tour, delhi day trip, delhi heritage tour, best delhi city tour package, delhi tourist attractions">
    ...
    <!-- Title -->
    <title>Same Day Delhi Tour | Taj Mahal Day Trip</title>
        ...
        <div class="swiper home2-banner-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="banner-bg"
                        style="background-image:linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(assets/img/innerpages/same-day-delhi-tour.jpg);">
                    </div>
                </div>
                ...
                <div class="col-xl-7 col-lg-8">
                    <div class="package-details-warpper">
                        <div class="package-info-wrap mb-60">
                            <h4>Same Day Delhi Tour</h4>
                            <p>Discover the vibrant culture, rich history, and architectural beauty of India’s capital with this Same Day Delhi Tour. This full-day Delhi sightseeing tour allows travelers to explore both Old Delhi and New Delhi, offering a perfect combination of historical monuments, cultural landmarks, and bustling markets.

                           During this Delhi city tour, you will visit famous attractions such as Jama Masjid, one of the largest mosques in India, and enjoy a glimpse of the lively streets of Old Delhi. The tour also includes iconic landmarks like India Gate, Qutub Minar, Humayun’s Tomb, and the beautiful Lotus Temple. Drive past the President House and Parliament House, showcasing the grandeur of New Delhi.</p>
                            ...
                            <div class="highlights-wrap">
                                <ul class="items-list">
                                    <li>
                                        ...
                                        Explore both Old Delhi and New Delhi in one day
                                    </li>
                                    <li>
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li>
                                        ...
                                        Explore the Mughal masterpiece Humayun’s Tomb
                                    </li>
                                    <li>
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
...
<ul class="itinerary-list">
  ...
  <li class="single-itinerary">
    ...
    <p>
      ...
      exciting <strong>Same Day Delhi Tour</strong>. Start the sightseeing with a visit to 
      <strong>Old Delhi</strong>, where you will explore the historic <strong>Jama Masjid</strong>, 
      one of the largest mosques in India. Enjoy a glimpse of the vibrant streets of 
      <strong>Chandni Chowk</strong> and take a photo stop at the iconic <strong>Red Fort</strong>.
    </p>

    <p>
      Continue the tour with a visit to <strong>Raj Ghat</strong>, the memorial of Mahatma Gandhi. 
      After exploring Old Delhi, proceed to <strong>New Delhi</strong> and drive past the impressive 
      <strong>President House</strong> and <strong>Parliament House</strong>. Stop at the famous 
      war memorial <strong>India Gate</strong> for photos.
    </p>

    <p>
      Later visit the UNESCO World Heritage Site <strong>Humayun’s Tomb</strong>, a beautiful 
      Mughal architectural masterpiece. Continue to the magnificent <strong>Qutub Minar</strong>, 
      the tallest brick minaret in the world and another UNESCO World Heritage Site.
    </p>

    <p>
      End your sightseeing with a visit to the peaceful <strong>Lotus Temple</strong>, known for its 
      unique flower-like architecture. After completing the tour, you will be dropped back at your 
      <strong>Hotel / Airport / Railway Station in Delhi</strong> with wonderful memories of your 
      Delhi city sightseeing experience.
    </p>
  </li>
...
Air-conditioned private car with professional driver for the complete Delhi sightseeing tour  </li>

		 <li><?php include('icons/right-tick-green.php'); ?>  Guided Tours & Excursions
Licensed English-speaking tour guide for exploring Old Delhi and New Delhi attractions  </li>
...
Visit popular landmarks including Jama Masjid, India Gate, Qutub Minar, Humayun’s Tomb and Lotus Temple  </li>
             ...
             <div class="single-feature-list">
                <h5>Excludes</h5>
                   <ul class="items-list two">
                    ...
                    <li> <?php include('icons/wrong-tick-red.php'); ?>  Optional Activities Rickshaw ride in Old Delhi or other optional experiences  </li>
                                ...
                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                The Same Day Delhi Tour covers major attractions of both Old Delhi and New Delhi including <strong>Jama Masjid, Chandni Chowk, Red Fort (photo stop), Raj Ghat, India Gate, Humayun’s Tomb, Qutub Minar, Lotus Temple, and President House</strong>.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                The tour usually takes around <strong>8 to 10 hours</strong>, depending on traffic conditions and the time spent at each attraction.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                Yes, a professional English-speaking tour guide is available to explain the history, culture, and architecture of Delhi’s famous monuments and attractions.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseFour" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                Yes, the tour can be customized according to your preferences. You can add or skip certain attractions, include shopping in local markets, or extend the tour duration if needed.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
