...
<head>
    ...
    <meta name="description" content="Get detailed itineraries and inclusions for India Taj Trip tour packages across Delhi, Agra, and Jaipur.">
    <meta name="keywords" content="tour package details, Golden Triangle itinerary, Taj Mahal tour details, India Taj Trip">
    ...
    <!-- Title -->
    <title>Tour Details | India Taj Trip</title>
                ...
                <div class="col-xl-7 col-lg-8">
                    <div class="package-details-warpper">
                        <div class="package-info-wrap mb-60">
                            ...
                            <p>India Taj Trip offers carefully designed Taj Mahal tour packages, Golden Triangle tours, and customized North India holiday packages for couples, families, and group travelers. Our tour packages include private AC car with driver, guided sightseeing, hotel assistance, and flexible itineraries to ensure a comfortable and hassle-free travel experience. Whether you are planning a same-day Taj Mahal tour from Delhi, Agra overnight trip, or Delhi–Agra–Jaipur tour, we provide affordable pricing, transparent services, and 24/7 booking support.</p>
						...
						<div class="tour-itinerary-area mb-60">
                            ...
                            <ul class="itinerary-list">
                                <li class="single-itinerary">
                                    <div class="location-title">
                                        <div class="icon">
                                            <svg width="16" height="16" viewBox="0 0 16 16"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M14.4555 2.20848L8.9555 14.2085C8.90963 14.3093 8.83158 14.392 8.73359 14.4437C8.63561 14.4954 8.52325 14.513 8.41414 14.4939C8.30503 14.4748 8.20536 14.42 8.13076 14.3381C8.05617 14.2562 8.01088 14.1519 8.002 14.0415L7.537 8.46298L1.959 7.99798C1.84877 7.98891 1.74466 7.94355 1.66297 7.869C1.58127 7.79444 1.5266 7.69491 1.50751 7.58596C1.48841 7.47702 1.50598 7.36483 1.55746 7.26694C1.60894 7.16905 1.69143 7.09099 1.792 7.04498L13.792 1.54498C13.8848 1.50238 13.9884 1.48922 14.0889 1.50725C14.1894 1.52528 14.2819 1.57364 14.3541 1.64584C14.4263 1.71803 14.4747 1.8106 14.4927 1.91109C14.5108 2.01158 14.4976 2.11519 14.455 2.20798L14.4555 2.20848Z" />
                                            </svg>
                                        </div>
                                    ...
                                    <div class="tour-plan-wrap">
                                        <div class="accordion accordion-flush" id="accordionTourPlan">
                                            <div class="accordion-item">
                                                <div class="accordion-header" id="flush-headingTourPlanOne">
                                                    <div class="accordion-button" role="button"
                                                        data-bs-toggle="collapse"
                                                        data-bs-target="#flush-collapseTourPlanOne"
                                                        aria-expanded="false" aria-controls="flush-collapseTourPlanOne">
                                                        <h6>
                                                            <span>
                                                ...
                                                <div id="flush-collapseTourPlanOne"
											...
											<div class="accordion-item">
                                                <div class="accordion-header" id="flush-headingTourPlanTwo">
                                                    <div class="accordion-button collapsed" role="button"
                                                        data-bs-toggle="collapse"
                                                        data-bs-target="#flush-collapseTourPlanTwo"
                                                        aria-expanded="false" aria-controls="flush-collapseTourPlanTwo">
                                                        <h6>
                                                            <span>
                                                                <svg width="14" height="14" viewBox="0 0 14 14"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <div id="flush-collapseTourPlanTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-item">
                                                <div class="accordion-header" id="flush-headingTourPlanThree">
                                                    <div class="accordion-button collapsed" role="button"
                                                        data-bs-toggle="collapse"
                                                ...
                                                <div id="flush-collapseTourPlanThree"
                                ...
                                <li class="single-itinerary">
                                    ...
                                    <div class="tour-plan-wrap">
                                        <div class="accordion accordion-flush" id="accordionTourPlan2">
                                            <div class="accordion-item">
                                                <div class="accordion-header" id="flush-headingTourPlanFour">
                                                    <div class="accordion-button collapsed" role="button"
                                                        data-bs-toggle="collapse"
                                                ...
                                                <div id="flush-collapseTourPlanFour" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-item">
                                                <div class="accordion-header" id="flush-headingTourPlanFive">
                                                    <div class="accordion-button collapsed" role="button"
                                                        data-bs-toggle="collapse"
                                                ...
                                                <div id="flush-collapseTourPlanFive" class="accordion-collapse collapse"
