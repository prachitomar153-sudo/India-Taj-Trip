...
<head>
    ...
    <meta name="description" content="Overnight Agra Tour by Car from Delhi with private AC vehicle. Visit Taj Mahal, Agra Fort & Mehtab Bagh with hotel stay & guided sightseeing.">
    <meta name="keywords" content="Overnight Agra Tour by Car from Delhi, Delhi to Agra overnight trip, Taj Mahal overnight tour, Agra tour package 2 days, Delhi to Agra private car tour, Taj Mahal tour with hotel stay, Agra sightseeing tour, Golden Triangle extension tour">
    ...
    <!-- Title -->
    <title>Overnight Agra Tour by Car from Delhi – India Taj Trip</title>
        ...
        <div class="swiper home2-banner-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="banner-bg"
                        style="background-image:linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(assets/img/innerpages/overnight-agra-tour-by-car-from-delhi.jpg);">
                    </div>
                </div>
        ...
        <div class="banner-content-wrap">
            <div class="container">
                <div class="banner-content">
                  <h1>Overnight Agra Tour by Car from Delhi</h1>
                    <div class="batch">
                        <span>Overnight Tour</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-7 col-lg-8">
                    <div class="package-details-warpper">
                        <div class="package-info-wrap mb-60">
                            ...
                            <p>Experience the beauty of the Taj Mahal and Agra Fort with our Overnight Agra Tour by Car from Delhi. This private tour includes comfortable AC car travel, professional driver, and guided sightseeing for a relaxed and memorable journey. Ideal for couples, families, and international travelers, this Delhi to Agra tour package allows you to explore Taj Mahal at sunrise, visit Mehtab Bagh, and discover Mughal heritage with a smooth same-day and next-day return experience.</p>
                            ...
                            <div class="highlights-wrap">
                                <ul class="items-list">
                                    <li>
                                        ...
                                        Private AC car transfer from Delhi to Agra with professional driver
                                    </li>
                                    <li>
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li>
                                        ...
                                        Optional government-approved tour guide service
                                    </li>
                                    <li>
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        Comfortable overnight stay in Agra (hotel optional)
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<ul class="itinerary-list">
  ...
  <li class="single-itinerary">
    ...
    <p>
      ...
      <strong>Agra via Yamuna Expressway</strong> (approx. 3–4 hours).
      Upon arrival meet your tour guide and begin sightseeing with a visit to the magnificent
      ...
      In the evening explore local markets famous for marble handicrafts and souvenirs.
      Check in at the hotel and relax. Overnight stay in Agra.
    </p>
  </li>
  ...
  <li class="single-itinerary">
    ...
    <p>
      Early morning enjoy a beautiful <strong>sunrise view of the Taj Mahal</strong>.
      Return to the hotel for breakfast and check out.
      Later visit the exquisite <strong>Itmad-ud-Daulah (Baby Taj)</strong>, known for its delicate
      marble inlay work and Mughal architecture.
      After sightseeing drive back to <strong>Delhi</strong>.
      Upon arrival you will be dropped at <strong>Delhi Airport / Hotel / Railway Station</strong>.
      Tour ends with wonderful memories of the Overnight Agra Tour.
    </p>
  </li>
...
Comfortable overnight stay in 3★ / 4★ / 5★ hotel in Agra (as per selected package)  </li>
...
Air-conditioned private car with professional driver for Delhi – Agra – Delhi transfers and local sightseeing  </li>
             ...
             <div class="single-feature-list">
                <h5>Excludes</h5>
                   <ul class="items-list two">
                    ...
                    <li> <?php include('icons/wrong-tick-red.php'); ?>  Optional Activities Cultural shows, rickshaw ride, photography services, etc. </li>
                                    ...
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingOne">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                ...
                                                aria-controls="flush-collapseOne">How long does the Delhi to Agra car journey take?</button>
                                        </h5>
                                        <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                            aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                The Delhi to Agra drive via Yamuna Expressway takes approximately 3–4 hours by private AC car, ensuring a smooth and comfortable road trip.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingTwo">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseTwo">Is the Taj Mahal sunrise visit included in the tour?</button>
                                        </h5>
                                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Yes, this overnight tour includes a sunrise Taj Mahal visit, offering the best photography and crowd-free sightseeing experience.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingThree">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseThree">What monuments are covered in this Agra tour package?</button>
                                        </h5>
                                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingThree"
                                            data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                The tour includes Taj Mahal, Agra Fort, Mehtab Bagh, and optional visit to Fatehpur Sikri, depending on your itinerary preference.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingFour">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseFour">Is hotel accommodation included in the overnight Agra tour?</button>
                                        </h5>
                                        <div id="flush-collapseFour" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Hotel stay can be arranged as per your budget category (3-star, 4-star, or 5-star) as part of the customized Agra tour package.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingFive">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseFive">How can I book the Overnight Agra Tour by Car from Delhi?</button>
                                        </h5>
                                        <div id="flush-collapseFive" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                You can book online, via phone, or WhatsApp for instant confirmation. We provide private taxi service, transparent pricing, and flexible tour customization.
                                            </div>
                                        </div>
                                    </div>
                                </div>
