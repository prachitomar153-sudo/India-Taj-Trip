...
<head>
    ...
    <meta name="description" content="Explore Delhi, Agra, Jaipur & Varanasi with our Golden Triangle Tour with Varanasi. Private car, guided sightseeing, Ganga Aarti & customizable holiday packages. Book now.">
    <meta name="keywords" content="Golden Triangle Tour with Varanasi, Delhi Agra Jaipur Varanasi tour, Golden Triangle Varanasi package, Taj Mahal Varanasi tour, 6 days Golden Triangle tour, India tour package with Varanasi, Delhi to Varanasi tour, private Golden Triangle tour India">
    ...
    <!-- Title -->
    <title>Golden Triangle Tour with Varanasi | Delhi Agra Jaipur Tour</title>
        ...
        <div class="swiper home2-banner-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="banner-bg"
                        style="background-image:linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(assets/img/innerpages/golden-triangle-tour-varanasi.jpg);">
                    </div>
                </div>
                ...
                <div class="col-xl-7 col-lg-8">
                    <div class="package-details-warpper">
                        <div class="package-info-wrap mb-60">
                            <h4>Golden Triangle Tour Varanasi</h4>
                            <p>The cultural richness of India with our Golden Triangle Tour with Varanasi, covering Delhi, Agra, Jaipur, and Varanasi in one unforgettable journey. Explore iconic landmarks like the Taj Mahal, Agra Fort, Amber Fort, India Gate, and witness the spiritual charm of the Ganga Aarti at Dashashwamedh Ghat. This private tour package includes comfortable AC car with driver, guided sightseeing, hotel stay options, and customizable itinerary, making it perfect for heritage lovers and spiritual travelers.</p>
                            ...
                            <div class="highlights-wrap">
                                <ul class="items-list">
                                    <li>
                                        ...
                                        Explore the majestic Taj Mahal at sunrise in Agra.
                                    </li>
                                    <li>
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        Explore Delhi’s historic sites – Qutub Minar, Humayun’s Tomb & India Gate.
                                    </li>
                                    <li>
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        Discover royal palaces and Amber Fort in Jaipur.
                                    </li>
                                    <li>
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        Experience the spiritual Ganga Aarti ceremony in Varanasi.
                                    </li>
                                    <li>
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        Enjoy a comfortable private car tour with professional driver & guide.
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<ul class="itinerary-list">
  ...
  <li class="single-itinerary">
    ...
    <p>
      ...
      Drive past President House and Parliament House. Later in the evening explore local markets.
  ...
  <li class="single-itinerary">
    ...
    <p>
      ...
      Upon arrival visit the magnificent <strong>Taj Mahal</strong>, one of the Seven Wonders of the World.
      Later explore the historic <strong>Agra Fort</strong>, a UNESCO World Heritage Site.
      Evening free to explore the famous marble handicraft markets of Agra.
  ...
  <li class="single-itinerary">
    ...
    <p>
      After breakfast drive towards <strong>Jaipur – The Pink City</strong>.
      En route visit the UNESCO World Heritage Site <strong>Fatehpur Sikri</strong>.
      Continue the journey to Jaipur and check in to the hotel.
  ...
  <li class="single-itinerary">
    ...
    <p>
      After breakfast enjoy a guided tour of <strong>Jaipur</strong>.
      Visit the majestic <strong>Amber Fort</strong>, followed by a photo stop at
      <strong>Hawa Mahal (Palace of Winds)</strong>. Continue exploring the royal
      <strong>City Palace</strong> and the astronomical observatory
      <strong>Jantar Mantar</strong>. Later transfer to the airport for your
      <strong>flight or overnight train to Varanasi</strong>.
    </p>
  </li>
  ...
  <li class="single-itinerary">
    <div class="location-title">
      ...
      <h5>Day 5 <span>( Departure: <strong>6:00 am - 6:30 am</strong> )</span></h5>
    </div>
    <p>
      Early morning enjoy a peaceful <strong>boat ride on the River Ganges</strong> and witness
      the spiritual life along the famous <strong>Ghats of Varanasi</strong>.
      Visit the sacred <strong>Kashi Vishwanath Temple</strong>, Sarnath and other important temples.
      In the evening experience the spectacular <strong>Ganga Aarti Ceremony</strong> on the ghats.
  ...
  <li class="single-itinerary">
    <div class="location-title">
      ...
      <h5>Day 6 <span>( Departure: <strong>9:00 am - 9:30 am</strong> )</span></h5>
    </div>
    <p>
      After breakfast transfer to <strong>Varanasi Airport</strong> for your flight to
      <strong>Delhi</strong>. Upon arrival in Delhi you will be transferred to
      <strong>Delhi Airport / Hotel / Railway Station</strong> for your onward journey.
      Your <strong>Golden Triangle Tour with Varanasi</strong> ends with unforgettable memories.
    </p>
  </li>
...
Comfortable stay in 3★ / 4★ / 5★ hotels (as per selected package) in Delhi, Agra, Jaipur & Varanasi (Hotel, resort or heritage property options available)  </li>
...
Licensed English-speaking tour guides in Delhi, Agra, Jaipur & Varanasi for sightseeing   </li>

          <li> <?php include('icons/right-tick-green.php'); ?>  Private Transportation
Air-conditioned private vehicle with professional driver for all transfers and sightseeing during the Golden Triangle tour   </li>

          <li> <?php include('icons/right-tick-green.php'); ?>  Boat Ride in Varanasi
Early morning boat ride on the sacred River Ganges to experience the famous Ghats of Varanasi   </li>
             ...
             <div class="single-feature-list">
                <h5>Excludes</h5>
                   <ul class="items-list two">
                    ...
                    <li> <?php include('icons/wrong-tick-red.php'); ?>  Monument Entrance Fees Entry tickets for Taj Mahal, Agra Fort, Amber Fort, temples and other monuments  </li>

                    <li> <?php include('icons/wrong-tick-red.php'); ?>  Domestic Flight / Train Tickets Delhi – Varanasi or Jaipur – Varanasi (if applicable)  </li>
                                    ...
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingOne">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                ...
                                                aria-controls="flush-collapseOne">What destinations are covered in the Golden Triangle Tour with Varanasi?</button>
                                        </h5>
                                        <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                            aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                This tour covers Delhi, Agra, Jaipur, and Varanasi, including major heritage monuments, UNESCO World Heritage Sites, and spiritual attractions along the Ganges River.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                Yes, the tour includes a guided visit to the Taj Mahal and Agra Fort, along with complete Agra sightseeing in a private AC car.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingThree">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseThree">How many days are required for the Golden Triangle with Varanasi tour?</button>
                                        </h5>
                                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingThree"
                                            data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                The ideal duration is 6 to 8 days, allowing comfortable travel between cities and enough time for sightseeing and spiritual experiences in Varanasi.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingFour">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseFour">Is this a private tour with driver and guide?</button>
                                        </h5>
                                        <div id="flush-collapseFour" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Yes, this is a private Golden Triangle tour package with a dedicated AC vehicle, professional driver, and optional government-approved tour guides in each city.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h5 class="accordion-header" id="flush-headingFive">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="flush-collapseFive">Can the itinerary be customized?</button>
                                        </h5>
                                        <div id="flush-collapseFive" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                Absolutely. The Golden Triangle with Varanasi tour itinerary can be customized based on hotel category, travel duration, pickup location, and preferred sightseeing attractions.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="swiper home1-trip-slider">
                        ...
                        <div class="package-img-wrap">
                            <div class="swiper package-card-img-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="golden-triangle-tour-ranthambore.php" class="package-img">
                                            <img src="assets/img/home1/golden-triangle-tour-ranthambore.jpg" alt="Golden Triangle Tour Ranthambore">
                                        </a>
                                    </div>
                                  </div>
                              </div>
                        ...
                        <div class="package-content">
                            <h5><a href="golden-triangle-tour-ranthambore.php">Golden Triangle Tour Ranthambore</a></h5>
                            <div class="location-and-time">
                                <div class="location">
                                    <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <a href="golden-triangle-tour-ranthambore.php">Ranthambore</a>
                                </div>
                                <svg class="arrow" width="25" height="6" viewBox="0 0 25 6" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0 3L5 5.88675V0.113249L0 3ZM25 3L20 0.113249V5.88675L25 3ZM4.5 3.5H20.5V2.5H4.5V3.5Z"/>
                                </svg>
                            ...
                            <div class="btn-and-price-area">
                                <a href="golden-triangle-tour-ranthambore.php" class="primary-btn1">
                                    <span>
                                        Book Now
                                        <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                            <path
